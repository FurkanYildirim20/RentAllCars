...
using RentAllCars.Core.Utilities.Results;


namespace RentAllCars.Core.Utilities.Helpers
{
    public class FileHelper
    {
        ...
        public static Results.IResult Upload(IFormFile file)
        {
            var fileExists = ChechFileExists(file);
        ...
        public static Results.IResult Update(IFormFile file, string imagePath)
        {
            var fileExists = ChechFileExists(file);
            if (fileExists.Message != null)
            {
        ...
        private static Results.IResult ChechFileExists(IFormFile file)
        {
        ...
        private static Results.IResult CheckFileTypeValid(string type)
        {
